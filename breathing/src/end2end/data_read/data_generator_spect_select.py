...
def read_data(challenge_folder, partition_to_id):
    ...
    for partition in partition_to_id.keys():
        ...
        for speaker_id in partition_to_id[partition]:
            ...
            selected_idxs= [67, 7, 65, 11, 6, 106, 2, 3, 64, 63]  # output-grad-based = [67, 7, 14, 11, 106, 6, 2, 3, 64, 63]
            data[partition][speaker_id]["wav"] = wav[:,selected_idxs]
            print(data[partition][speaker_id]["wav"].shape)
